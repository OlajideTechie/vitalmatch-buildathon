...
function HospitalRegister() {
  // State to manage the custom dropdown for "Blood Group"
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        ...
        <div className="text-[#C84A4A] font-bold text-lg mb-10 md:hidden">
          ...
          <p className="text-gray-500 text-sm mb-8">
            Let's finish setting up your hospital account. This information helps us send you the right requests at the right time.
          </p>
          ...
          <form className="space-y-4 relative">
            ...
            <div className="relative">
              <select 
                ...
                defaultValue=""
              >
                <option value="" disabled>Have You Ever Donate?</option>
