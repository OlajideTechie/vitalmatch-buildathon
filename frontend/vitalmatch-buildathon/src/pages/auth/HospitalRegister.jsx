      ...
      <div className="w-full lg:w-1/2 h-full overflow-y-auto scroll-smooth">
        <div className="min-h-full flex flex-col items-center justify-center p-8 py-12">
          <div className="w-full max-w-md">
            ...
            <h2 className="text-2xl font-bold text-[#0A0A0A] mb-2">Hospital Information</h2>
            <p className="text-[#434248] text-sm mb-8">
              Provide your hospital details for verification. This information will be reviewed by our team within 24-48 hours. Only verified hospitals can create blood requests on BloodConnect.
            </p>
            {globalError && (
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col gap-1">
                <label className="text-sm font-medium text-[#797B8B]">Hospital Name</label>
                <input 
                  type="text" 
                  name="fullName"
            ...
            <div className="flex flex-col gap-1 relative">
                <label className="text-sm font-medium text-[#797B8B]">Type of Hospital</label>
                <select 
                  name="hospitalType"
                  value={formData.hospitalType}
                  onChange={handleInputChange}
                  className={`w-full border rounded-lg p-3.5 text-sm text-[#1C1C1C] appearance-none focus:outline-none focus:ring-1 bg-white ${errors.hospitalType ? 'border-red-400 focus:ring-red-300' : 'border-gray-200 focus:ring-gray-300'}`}
                >
                  <option value="" disabled>Select hospital type</option>
                  <option value="government">Government</option>
                  <option value="private">Private</option>
                </select>
                <ChevronDown className="absolute right-4 top-[70%] -translate-y-1/2 text-gray-400 w-4 h-4 pointer-events-none" />
                {errors.hospitalType && <span className="text-red-500 text-xs mt-0.5">{errors.hospitalType}</span>}
              </div>
              ...
              <div className="flex flex-col gap-1">
                <label className="text-sm font-medium text-[#797B8B]">RC Number</label>
                <input 
                  type="number" 
                  name="rcNumber"
                  ...
                  className={`w-full border rounded-lg p-3.5 text-sm text-[#1C1C1C] placeholder-gray-400 focus:outline-none focus:ring-1 ${errors.rcNumber ? 'border-red-400 focus:ring-red-300' : 'border-gray-200 focus:ring-gray-300'}`}
                />
                {errors.rcNumber && <span className="text-red-500 text-xs mt-0.5">{errors.rcNumber}</span>}
              </div>
